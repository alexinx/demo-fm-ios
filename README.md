...
DemoAlexSDK is available through [CocoaPods](https://cocoapods.org). To install
...
DemoAlexSDK is available under the MIT license. See the LICENSE file for more info.
